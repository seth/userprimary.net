...
module UserPrimary
  module Helpers
  # shameless copy of Nanoc3::Helpers::Blogging with the sole
  # purpose of changing the behavior of how article updates
  # are handled.
  #
  ...
  module Blogging
    ...
    #
    # The feed will also include dates on which the articles were
    # updated using the article's updated_at attribute if present.
    # Otherwise, the value of created_at is used.
    #
      ...
      xml.feed(:xmlns => 'http://www.w3.org/2005/Atom') do
        ...
        sorted_relevant_articles.each do |a|
          ...
          xml.entry do
            ...
            if a[:updated_at]
              xml.updated Time.parse(a[:updated_at]).to_iso8601_time
            else
              xml.updated Time.parse(a[:created_at]).to_iso8601_time
            end
